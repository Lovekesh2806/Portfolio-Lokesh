    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="relative flex justify-center mb-16">
          ...
          <img
            src="https://static.vecteezy.com/system/resources/thumbnails/050/980/766/small/3d-coder-working-on-website-illustration-png.png"
            alt="Profile"
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <p className="text-lg text-gray-600">
              I started my journey in web development back in 2022, working with
              startups. My expertise spans across the entire web development
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-lg text-gray-600">
              Building robust and scalable server solutions with Java,
              Springboot
            </p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
